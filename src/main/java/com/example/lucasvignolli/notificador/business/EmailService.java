package com.example.lucasvignolli.notificador.business;


import com.example.lucasvignolli.notificador.business.dto.TarefasDTO;
import com.example.lucasvignolli.notificador.infrastructure.exceptions.EmailExceptions;
...
public class EmailService {
    ...
    public void enviaEmail (TarefasDTO dto){
        try {
            ...
            mimeMessageHelper.setFrom(new InternetAddress(remetente, nomeRemente));
            ...
            throw new EmailExceptions("Erro ao enviar email ", e.getCause());
        }
    }
}
